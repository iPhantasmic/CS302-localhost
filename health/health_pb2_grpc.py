...
class Health(object):
    ...
    def Check(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/health.Health/Check',
            health_dot_health__pb2.HealthCheckRequest.SerializeToString,
            health_dot_health__pb2.HealthCheckResponse.FromString,
