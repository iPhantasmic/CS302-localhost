...
class BookingService(object):
    ...
    def GetAvailableListings(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bookings.BookingService/GetAvailableListings', bookings__pb2.GetAvailableListingsRequest.SerializeToString, bookings__pb2.GetAvailableListingsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)