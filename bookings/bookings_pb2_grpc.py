...
class BookingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAvailableListings = channel.unary_unary('/bookings.BookingService/GetAvailableListings', request_serializer=bookings__pb2.GetUnavailableListingsRequest.SerializeToString, response_deserializer=bookings__pb2.GetUnavailableListingsResponse.FromString)
...
class BookingService(object):
    ...
    @staticmethod
    def GetAvailableListings(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bookings.BookingService/GetAvailableListings', bookings__pb2.GetUnavailableListingsRequest.SerializeToString, bookings__pb2.GetUnavailableListingsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)